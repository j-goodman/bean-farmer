...
const imageLoader = (addImage) => {
    ...
    addImage("pine-tree")
    addImage("pine-sprout")
    addImage("pine-sprout-square")
    addImage("pine-sapling-young")
    addImage("pine-sapling-mature")
    addImage("pinecone")
    addImage("birchpod")
    addImage("birch-tree")
    addImage("birch-sprout")
    addImage("birch-sprout-square")
    addImage("birch-sapling-young")
    addImage("birch-sapling-mature")
